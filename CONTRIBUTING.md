...
5. Run the relevant build, test, documentation, license, secret, dependency, and SBOM gates described below, in proportion to the changed surface.
...
This repository publishes curated source snapshots. Propose code changes in the
[development repository](https://github.com/msala9/secure-integration-platform);
the original authorship and DCO attestations remain there. Snapshot commits identify
the corporate publisher, not a replacement author for the underlying contributions.
