...
Follow [M3A split-host — manual execution in the VM](https://github.com/msala9/secure-integration-platform/blob/b13e6ba781a90d331836d37ec363baf27248737f/docs/operations/M3A-SPLIT-HOST-CODEX-VM.md).
