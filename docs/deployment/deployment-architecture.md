...
authorized A1/S1 material. The shipped [validation/status pilot](https://github.com/ApoCert-it/secure-integration-platform/blob/main/docs/user/fse2-validation-status.md)
